...
Для обычного доступа можно зарегистрировать пользователя самостоятельно, если хотите

Восстановление пароля на бесплатном хостинге не получилось подключить - вызвано ограничением бесплатного размещения)
Но если развернуть на локалке с использованием инструкции, приложенной к git-репозиторию - все работает ( как и демонстрировали вчера )

Также медленная загрузка страниц связана с бесплатным периодом хостинга. Сайт "засыпает", если на него не поступают запросы за ~30 мин. затем просыпается по обращению , но, как вы понимаете, за некоторое время.
